        ...
        <div className="flex items-center gap-3">
          ...
          {!isReadOnly && (
            <CsvImportButton
              ...
              schemaKeys={['deliveryNumber', 'totalHT', 'totalTTC', 'date', 'paymentMethod', 'clientId', 'clientName', 'items']}
              idPrefix="dlv"
              className="px-6 py-3 bg-white border border-slate-200 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 shadow-sm hover:bg-slate-50 transition-all active:scale-95"
            />
          )}
